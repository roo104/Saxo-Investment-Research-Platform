...
class SignalsController(private val watchlistService: WatchlistService) {

    @GetMapping("/{id}/signals")
    @Operation(
        summary = "Get computed technical signals for a watchlist item",
    ...
    ): Signals = watchlistService.signals(id, horizon, count.coerceIn(1, 1200))
}
